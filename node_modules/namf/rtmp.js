...
(function() {
    ...
    RTMPClient.prototype.messageReceived = function(msg) {
      ...
      if ((msg.type === RTMPMessage.RPC || msg.type === RTMPMessage.RPC3) && msg.streamId === 0) {
        try {
          ...
          console.log('RTMPClient.messageReceived error: ' + e);
          this.socket.destroySoon();
          //wait for a timeout to clear things TODO: should probably fix this!
          return;
        }
  ...
  RTMPCommand = (function() {
    ...
    RTMPCommand.fromMessage = function(message) {
      ...
      //console.dir(cmd.args[0].body.name);
      //if (cmd.args && cmd.args[0].body && 'com.riotgames.platform.summoner.PublicSummoner' === cmd.args[0].body.name) throw 'unknown-error';
      return cmd;
    };
