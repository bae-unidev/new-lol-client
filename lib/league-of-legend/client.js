...
LolClient.prototype.getStoreUrl = function () {
  var rawData = this.sendMessage("loginService", "getStoreUrl", []).toString();
  console.log(JSON.parse(rawData).data.body);
  return JSON.parse(rawData).data.body;
}
